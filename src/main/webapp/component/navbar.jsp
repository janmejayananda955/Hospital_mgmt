		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			<ul class="navbar-nav ms-auto mb-2 mb-lg-0">
				<c:if test="${empty userObj }">
					...
					<li class="nav-item"><a class="nav-link active"
						aria-current="page" href="gallery.jsp"><i class="fa-solid fa-image"></i> Gallery</a></li>
					<li class="nav-item"><a class="nav-link active"
...
<!-- 					<li class="nav-item"><a class="nav-link active" -->
<!-- 						aria-current="page" href="bed_booking.jsp">Bed Booking</a></li> -->
					<li class="nav-item"><a class="nav-link active"
					...
					<div class="dropdown">
						<button class="btn btn-danger dropdown-toggle" type="button"
							...
							aria-expanded="false">
							<i class="fa-solid fa-user"></i>Hello ${userObj.userName}
						</button>
